      ...
      <div className="flex items-center gap-1 md:order-2 md:gap-2.5">
        ...
        <SignedOut>
          <Link href="/sign-in">
            ...
            >
              <span className="relative rounded-md bg-white px-2 py-1.5 transition-all duration-75 ease-in group-hover:bg-transparent md:px-5 md:py-2.5 dark:bg-gray-700 group-hover:dark:bg-transparent">
                Sign In
              </span>
            </button>
          </Link>
